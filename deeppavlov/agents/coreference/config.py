...
def add_cmdline_args(parser):
    ...
    agent.add_argument('--char_vocab_path', type=str, default=".build/coreference/russian/vocab/char_vocab.russian.txt")
    ...
    agent.add_argument('--embedding_path', type=str, default='.build/coreference/russian/embeddings/embeddings_lenta_100.vec')
    ...
    agent.add_argument('--log_root', type=str, default='.build/coreference/russian/logs')

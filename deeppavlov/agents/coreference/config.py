...
#    agent.add_argument('--char_vocab_path', type=str, default="./src/parlai/data/coreference/russian/vocab/char_vocab.russian.txt")
...
#    agent.add_argument('--embedding_path', type=str, default='./src/parlai/data/coreference/russian/embeddings/embeddings_lenta_100.vec')

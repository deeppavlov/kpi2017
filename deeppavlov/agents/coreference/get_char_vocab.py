...
def get_char_vocab_language(language):
  get_char_vocab(["./data/{}.{}.jsonlines".format(partition, language) for partition in ("train", "dev", "test")], "./vocab/char_vocab.{}.txt".format(language))

get_char_vocab_language("russian")

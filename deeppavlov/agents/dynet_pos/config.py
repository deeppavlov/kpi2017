def add_cmdline_args(parser):
    # Runtime environment
    agent = parser.add_argument_group('dynet pos_tagger Arguments')
    # agent.add_argument('--cuda', type='bool', default=False)
    # agent.add_argument('--gpu', type=int, default=-1)
    agent.add_argument('-hs', '--hidden-size', type=int, default=23)
    agent.add_argument('-wd', '--word-dim', type=int, default=1000)
    agent.add_argument('--depth', type=int, default=2)
    ...
    agent.add_argument('--learning_rate', '-lr', type=float, default=0.5,

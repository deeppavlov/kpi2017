...
class SquadModel(object):
    ...
    def fastqa_default(self):
        ...
        '''Answer span prediction'''
        # Answer start prediction
        answer_start = answer_start_pred(passage_encoding, question_attention_vector, P_mask, 25, self.linear_dropout)
        # Answer end prediction
        answer_end = answer_end_pred(passage_encoding, question_attention_vector, P_mask, answer_start, 25, self.linear_dropout)

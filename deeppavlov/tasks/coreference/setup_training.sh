...
#ontonotes_path=/home/petrov/coreference_kpi/code/e2e-coref/
#bash conll-2012/v3/scripts/skeleton2conll.sh -D $/ontonotes_path conll-2012
...
#    compile_partition development dev v4 _auto_skel $1
#    compile_partition train train v4 _auto_skel $1
#    compile_partition test test v4 _gold_skel $1
}
